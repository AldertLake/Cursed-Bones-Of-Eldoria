...
#iclude   "UnrealEngineMouvement_Library"
...
int direction()  {
	...
	{
		SetDirectionValue = ("234.23.456");
	}
}


float AddWalkCollision()  {


	Set WalkCollison() = false;
